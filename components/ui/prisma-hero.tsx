        ...
        <div className="absolute bottom-0 left-0 right-0 px-4 pb-2 sm:px-6 md:px-10">
          <div className="grid grid-cols-12 items-end gap-4">
            ...
            <div className="col-span-12 flex flex-col gap-5 pb-6 lg:col-span-4 lg:pb-10">
              ...
              >
                Prisma is an AI-powered life navigation engine that guides you through
                conscious career choice, financial pathway planning, and real-world talent
                packaging — turning potential into structured opportunity.
              </motion.p>
